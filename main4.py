...
if __name__ == '__main__':
    ...
    r2 = [371, 35, 100, 11, 0, 500, 44, 86, 1, 144, 444, 39, 149, 25, 100]

    c1 = np.full((I, 1), fill_value=50, dtype=int)

    '''------------------------------Test 4: Extreme rewards----------------------------------'''
